...
window.imgToGif1 = function () {
  microsoft.src =
    "https://cdn.dribbble.com/users/778585/screenshots/4180944/endtagexploration_microsoftdribbble.gif";
};

window.gifToImg1 = function () {
  microsoft.src =
    "https://www.pngmart.com/files/4/Microsoft-Logo-PNG-Picture.png";
};

window.imgToGif2 = function () {
  jpMorgan.src =
    "https://images.squarespace-cdn.com/content/v1/5feb53185d3dab691b47361b/1609930688940-VT0ZDCO6OG19NU8RXNP4/c70e9-chase_header_blog.gif?format=500w";
};

window.gifToImg2 = function () {
  jpMorgan.src =
    "https://logos-world.net/wp-content/uploads/2021/02/JP-Morgan-Chase-Emblem.png";
};
...
window.gifToImg3 = function () {
  efs.src =
    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/EFS_Logo.png/1200px-EFS_Logo.png";
};

window.imgToGif4 = function () {
  afflux.src =
    "https://i0.wp.com/aeonenergy.co.nz/wp-content/uploads/2018/07/how-solar-energy-works.gif?fit=1024%2C400&ssl=1";
};
